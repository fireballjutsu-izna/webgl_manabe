...
**第3部**で作品を 2 つ、最初から最後まで組み上げ、
**第4部**でそれを人に見せられる形に仕上げます。
第2部より後のコードはすべて、このページの中で書き換えて動かせます。
`;
...
- **章末には演習があります。** 手を動かす課題です。答え合わせはしないので、詰まったら解答例を開いてください。
- **章末のクイズは、間違えても大丈夫です。** どちらを選んでも解説が出ます。
- **詰まったら[逆引き](#/help)へ。** 「真っ黒」「色が違う」「影が出ない」「重い」から、確かめる順に並べてあります。
`;
