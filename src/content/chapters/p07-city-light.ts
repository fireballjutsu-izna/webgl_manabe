...
- 太陽の向き … $t$ を角度にして円を描く（[1-05](#/ch/05-trig)）
- 太陽の強さと色 … 太陽の**高さ**から決める
- 空とフォグの色 … 夜の色と昼の色を、高さで混ぜる（[1-08](#/ch/08-interp)）
- 窓の明かり … 太陽が沈んだぶんだけ点ける
...
[2-14](#/ch/t14-fragment-shader)でシェーダの中で使ったものと同じ働きで、
...
[2-05](#/ch/t05-light-shadow)でやったとおり、影は「光から見たカメラ」で撮った距離の記録です。
...
夜の街に街灯を置きたくなります。ところが[2-05](#/ch/t05-light-shadow)でやったとおり、
...
- **{{加算ブレンド}}で光の芯を足す。** [3-03](#/ch/p03-planet-atmosphere)の大気と同じやり方
...
そのとき \`shadow.camera\` を書き換えたら、\`updateProjectionMatrix()\` を忘れないでください（1-10 と同じ話です）。`,
    },
  ],
  quiz: [
    {
