...
これ 1 つで、2-01 でやった 3 点セットが全部立ち上がります。
...
2-10 で見たとおり、\`dispose\` 漏れは SPA では致命傷になります。
...
3 つとも「はい」なら入れる価値があります。**1 つでも「いいえ」なら、素の three のままで困りません。**`,
  ...
  quiz: [
    ...
    },
    {
      ...
      answer: 0,
      explain:
        'R3F が生成と破棄の両方を持っているので、外れたときに解放まで面倒を見ます。素の three では自分で書く必要があり、書き忘れが SPA での黒画面につながります（2-10）。',
    },
    {
