...
[2-14 フラグメントシェーダ](#/ch/t14-fragment-shader)で書いたものと**構造は同じ**です。
...
composer.addPass(myPass);   // RenderPass と OutputPass のあいだに挟む`,
    },
    {
      ...
      title: 'ここでもリニアのままです',
      text: `
自前パスに届く色は**リニア**です（[4-02](#/ch/q02-color)の話）。
...
[1-02](#/ch/02-vector)と[1-03](#/ch/03-dot)がここでも顔を出します。
`,
    },
    {
      kind: 'formula',
...
この 2 つがそろえば、あとは 2-14 で書いたフラグメントシェーダとまったく同じ書き方でよくなります。`,
    },
  ],
  quiz: [
    {
