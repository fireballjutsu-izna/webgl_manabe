...
export const chapterQ05: Chapter = {
  slug: 'q05-ship-it',
  part: 'polish',
  number: 5,
  title: 'アプリにする',
...
[3-07](#/ch/p07-city-light)で「時刻という 1 つの値から、光も空も影も窓も導く」とやりました。
...
[3-02](#/ch/p02-planet-surface)の惑星は、テクスチャの生成に数百ミリ秒かかりました。
...
ブラウザが同時に持てる WebGL の枠は 8〜16 個しかありません（[2-10](#/ch/t10-scene-graph)）。
...
- **4-01** … 映り込み。金属が黒い理由と、素材なしで環境マップを作る方法
- **4-02** … 色の通り道。リニアと sRGB、そしてトーンマッピング
- **4-03** … ポストプロセス。3 点セットと、\`OutputPass\` を忘れたときの壊れ方
- **4-04** … 自前のパス。フラグメントシェーダの知識が、そのまま画面加工になる
- **4-05** … 品質・読み込み・触り方・公開

**この 5 章は、どれも「新しく作る」話ではありませんでした。**
